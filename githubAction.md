## github action小白教程， 可以参考这边的 [github action使用教程](https://ruicky.me/2020/06/05/jd-sign/)
...
- 上面 [github action使用教程](https://ruicky.me/2020/06/05/jd-sign/) 获取ck的方法不对。继续参考我readme里面 [浏览器获取京东cookie教程](https://shimo.im/docs/CTwhjpG6ydvC3qJJ/) 获取ck。
...
copy(CookieValue);
```
- fork过后，acton没有看到运行，是因为.yml文件里面的cron时间未到，如需立马看到效果，请在相应的.yml文件(路径：scripts/.github/workflows/xxx.yml)里面，添加下面的设置
